...
#define BATTLE_DEFAULT_DODGE_PERCENT 0
#define BATTLE_DEFAULT_WARNING_PERCENT 30
#define BATTLE_DEFAULT_COUNTER_PERCENT 40
...
#define AI_WEIGHT_SCRATCH_TARGET_DAMAGE_PRESSURE 10
#define AI_WEIGHT_SCRATCH_RAGE_PRESSURE 5
